...
global.email = 'www.sehanthilakarathna@gmail.com'
global.github = 'https://github.com/prabathLK/PRABATH-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.devs = '+94769834458';
global.website = 'https://github.com/SEHANLK/SEHAN-MD' //wa.me/+94769834458
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'SEHAN-MD',
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY SEHAN-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'PRABATH',
  sessionName: process.env.SESSION_ID || 'mU8yVYwQ#SClJ5Czs9gWbSh-FgERJPgj7h_YaSgiet1LxVSXQtuU',
  ...
  LANG: process.env.THEME|| 'SEHAN-MD',
