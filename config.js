...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("+94769834458")
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'shehan-MD',
  ...
  ownername:process.env.OWNER_NAME || 'sehan',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~wv9TXTZJ#LCfeph_taSGdIfZ9JqJh_CnA6-OpoUrmd64ddp2dPls',
